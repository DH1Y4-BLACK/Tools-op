...
\033[97m
\t------------
\nCreator:\033[97m Dhiya ID
Team: Black Cyber
Youtube: ga punya
Github : github.com/Fuck
==========================================''')
...
def vak(s):
    for c in s + '\n':
        ...
        sys.stdout.flush()
        time.sleep(1./1000)
kata("ksjsjsnsjjsnsjkjsnsknsndksmsnddjskmdnjdkmdns")
def jenius():
    ua={
    "accept": "*/*",
...
if __name__=="__main__":
     try:
          ...
          clear()
          kata("\033[92;1m╔═══════════════════════════════╗")
          kata("║ Wellcome to Dhiya Brutal spam ║")
          kata("╚═══════════════════════════════╝")
          kata('''
          ................(_)
          ...............(___)
          ...
          clear()
          vak('''
\033[92;1m\033[91m11111111¶111111111111111111111111111111111111
